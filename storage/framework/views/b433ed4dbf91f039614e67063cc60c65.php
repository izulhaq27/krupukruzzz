    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="card border-0 shadow-sm h-100 p-3" style="border-radius: 4px;">
                ...
                <div class="mt-3">
                    <h3 class="fw-bold mb-1 text-dark"><?php echo e($totalProducts); ?></h3>
        ...
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="card border-0 shadow-sm h-100 p-3" style="border-radius: 4px;">
                ...
                <div class="mt-3">
                    <h3 class="fw-bold mb-1 text-dark">Rp <?php echo e(number_format($totalRevenue, 0, ',', '.')); ?></h3>
        ...
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="card border-0 shadow-sm h-100 p-3" style="border-radius: 4px;">
                ...
                <div class="mt-3">
                    <h3 class="fw-bold mb-1 text-dark"><?php echo e($newOrders); ?></h3>
        ...
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="card border-0 shadow-sm h-100 p-3" style="border-radius: 4px;">
                ...
                <div class="mt-3">
                    <h3 class="fw-bold mb-1 text-dark"><?php echo e($totalUsers); ?></h3>
            ...
            <div class="card border-0 shadow-sm p-4" style="border-radius: 4px;">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        ...
                        <p class="text-muted small mb-0">Year <?php echo e(date('Y')); ?></p>
                    </div>
                </div>
                ...
                <table class="table table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="d-block text-dark"><?php echo e($order->user->name ?? 'Guest'); ?></span>
                            </td>
                            <td class="text-dark fw-bold">Rp <?php echo e(number_format($order->total_amount, 0, ',', '.')); ?></td>
                            <td>
                                ...
                                <?php else: ?>
                                    <span class="badge bg-secondary bg-opacity-10 text-secondary rounded-pill px-3"><?php echo e($order->status); ?></span>
                                <?php endif; ?>
                            </td>
