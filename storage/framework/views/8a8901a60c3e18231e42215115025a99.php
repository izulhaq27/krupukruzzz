...
<div class="container my-5">
    ...
    <?php if(empty($cart)): ?>
        <div class="text-center py-5">
            ...
            <a href="<?php echo e(route('products.index')); ?>" class="btn btn-success btn-lg mt-3">
    ...
    <?php else: ?>
        <div class="row">
            <div class="col-lg-8 mb-4">
                        ...
                        <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="row align-items-center mb-4 pb-4 border-bottom">
                                ...
                                <div class="col-md-3 col-8 mb-3 mb-md-0">
                                    <h6 class="fw-bold mb-2" style="color: #333;"><?php echo e($item['name']); ?></h6>
                ...
                <!-- Continue Shopping -->
                <div class="mt-3">
                    <a href="<?php echo e(route('products.index')); ?>" class="btn btn-outline-success" style="
                        border-color: #28a745;
                        color: #28a745;
                    ">
                ...
                ">
                    ...
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between mb-3">
                            <span class="text-muted">Subtotal (<?php echo e(count($cart)); ?> item)</span>
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <div class="d-grid">
                                <a href="<?php echo e(route('checkout.index')); ?>" class="btn btn-lg" style="
                                    background: #28a745;
                                    color: white;
                                    border-radius: 8px;
                                    font-weight: 600;
                        ...
                        <?php else: ?>
                            ...
                            <div class="d-grid gap-2">
                                <a href="<?php echo e(route('login')); ?>" class="btn btn-lg" style="
                                    background: #28a745;
                                    color: white;
                                    border-radius: 8px;
                                    font-weight: 600;
                                ...
                                <a href="<?php echo e(route('register')); ?>" class="btn btn-outline-success" style="
                                    border-color: #28a745;
                                    color: #28a745;
                                    border-radius: 8px;
                                    font-weight: 500;
