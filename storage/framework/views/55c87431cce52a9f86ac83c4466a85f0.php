    ...
    <div class="w-full max-w-lg">
        ...
        <div class="bg-white rounded-3xl border border-slate-100 shadow-[0_10px_40px_rgba(0,0,0,0.06)] overflow-hidden animate-[fadeInUp_0.5s_cubic-bezier(0.4,0,0.2,1)_forwards]" style="animation-delay: 0.1s;">
            <div class="p-8 sm:p-10">
                <form method="POST" action="<?php echo e(route('tracking.check')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <a href="<?php echo e(route('login')); ?>" class="w-full flex justify-center items-center bg-white border-2 border-slate-200 text-slate-600 hover:border-slate-300 hover:bg-slate-50 font-medium py-3 rounded-full transition-all">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Umkm_Krupuk\resources\views/tracking/index.blade.php ENDPATH**/ ?>