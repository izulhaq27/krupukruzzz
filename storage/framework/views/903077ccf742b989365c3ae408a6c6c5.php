    ...
    <div class="invoice-container">
        ...
        <div class="invoice-header">
            ...
            <div class="invoice-details">
                <h2>INVOICE</h2>
                <p>
                    <strong>No. Invoice:</strong> #<?php echo e($order->order_number); ?><br>
                    <strong>Tanggal:</strong> <?php echo e($order->created_at->format('d M Y, H:i')); ?><br>
                    <strong>Status:</strong> <span style="text-transform: uppercase;"><?php echo e($order->status); ?></span>
                </p>
            </div>
        </div>
            ...
            <div class="info-col">
                ...
                <div class="info-content">
                    ...
                    <div style="max-width: 300px;">
                        ...
                        <?php echo e($order->city ? $order->city . ',' : ''); ?> <?php echo e($order->province); ?><br>
                        <?php echo e($order->postal_code ? 'Kode Pos: ' . $order->postal_code : ''); ?>
                ...
                <div class="info-content">
                    <?php if($order->tracking_number): ?>
                        ...
                        <span style="color: #777; font-size: 12px;">
                            <?php echo e(strtoupper($order->shipping_courier ?? 'Ekspedisi')); ?> 
                            <?php echo e(strtoupper($order->shipping_service ?? '')); ?>
        ...
        <table class="invoice-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: center;"><?php echo e($qty); ?></td>
                    <td style="text-align: right;">Rp <?php echo e(number_format($price, 0, ',', '.')); ?></td>
                    <td class="amount">Rp <?php echo e(number_format($subtotal, 0, ',', '.')); ?></td>
                </tr>
        ...
        <div class="totals-section">
            <table class="totals-table">
                <tr>
                    ...
                    <td>Rp <?php echo e(number_format($order->subtotal ?? $order->items->sum(fn($i) => $i->price * $i->quantity), 0, ',', '.')); ?></td>
                </tr>
                <tr>
                    <td>Ongkos Kirim</td>
                    <td>Rp <?php echo e(number_format($order->shipping_cost ?? 0, 0, ',', '.')); ?></td>
                </tr>
...
<?php /**PATH C:\laragon\www\Umkm_Krupuk\resources\views/admin/orders/print.blade.php ENDPATH**/ ?>