            ...
            <div class="col-md-4 col-lg-3 mb-4">
                <div class="card category-card h-100 border-0 shadow-sm">
                    <div class="card-body text-center">
                        ...
                        <h5 class="fw-bold mb-2"><?php echo e($category->name); ?></h5>
                        
                        <?php if($category->description): ?>
                            <p class="text-muted small mb-3"><?php echo e(Str::limit($category->description, 80)); ?></p>
                        <?php endif; ?>
                        
                        <div class="mb-3">
                            <span class="badge bg-light text-dark">
                                <i class="bi bi-box"></i> <?php echo e($category->products_count); ?> Produk
                            </span>
                        </div>
