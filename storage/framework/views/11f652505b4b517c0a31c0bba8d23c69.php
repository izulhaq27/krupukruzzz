...
<div class="container-fluid mt-4">
    ...
    <div>
        ...
        <p class="text-muted mb-0 small">Total <?php echo e($products->count()); ?> produk</p>
    </div>
    <a href="<?php echo e(route('admin.products.create')); ?>" class="btn fw-bold" 
                    ...
                    <tr class="border-bottom">
                        ...
                        <td style="padding: 16px;">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1">
                                    <div class="fw-medium" style="color: #1e293b;"><?php echo e($p->name); ?></div>
                        ...
                        <td style="padding: 16px;">
                            <?php $__currentLoopData = $p->categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span class="badge bg-light text-dark"><?php echo e($category->name); ?></span>
                        ...
                        <td style="padding: 16px;">
                            <span class="badge" style="
                                background: <?php echo e($p->stock > 0 ? '#d1fae5' : '#fee2e2'); ?>;
                                color: <?php echo e($p->stock > 0 ? '#065f46' : '#991b1b'); ?>;
                                padding: 4px 12px;
                                border-radius: 20px;
                                font-weight: 500;
                            ">
                                <?php echo e($p->stock > 0 ? $p->stock . ' pcs' : 'Stok Habis'); ?>
