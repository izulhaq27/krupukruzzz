...
<head>
    ...
    <title>Invoice #{{ $order->order_number }} - KrupuKruzzz</title>
    ...
    <div class="container py-4">
        <div class="invoice-container">
            ...
            <div class="d-flex justify-content-between mb-4 no-print">
                <a href="{{ route('orders.show', $order->order_number) }}" class="btn btn-outline-secondary">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-end">
                        <div class="invoice-info">
                            ...
                            <p class="mb-1"><strong>No. Invoice:</strong> {{ $order->order_number }}</p>
                            <p class="mb-1"><strong>Tanggal:</strong> {{ $order->created_at->format('d F Y') }}</p>
                            <p class="mb-0">
                                ...
                                @endphp
                                <span class="status-badge {{ $statusColors[$order->status] ?? 'bg-secondary' }}">
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-sm table-borderless mb-0">
                                ...
                                <tr>
                                    ...
                                    <td>: {{ $order->shipping_service ?? 'REG' }}</td>
                                </tr>
                ...
                <div class="col-md-4">
                    <div class="total-box">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <h4 class="fw-bold mb-0">Rp {{ number_format($order->total_amount, 0, ',', '.') }}</h4>
                        </div>
                        
                        @if($order->payment_type)
                        <div class="mt-3 pt-3 border-top border-white">
                            <p class="mb-1"><strong>Metode Pembayaran:</strong></p>
                            <p class="mb-0">{{ strtoupper($order->payment_type) }}</p>
                        </div>
                        @endif
                    </div>
                </div>
